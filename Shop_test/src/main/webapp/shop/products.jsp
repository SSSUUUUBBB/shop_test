...
<body>   
					...
					<div class="card p-3">
						...
						<div class="content">
							...
							<p class="d-flex justify-content-between">
	       						 <a class="nav-link position-relative" aria-current="page" href="cart_pro.jsp">
	...
	<%
		}else{ List<Product> productList = productDAO.list(keyword); 
	%>
	<div class="container mb-5">
		<div class="row gy-4">
			<%
			...
			<div class="col-md-6 col-xl-4">
					<div class="card p-3">
						...
						<div class="content">
							...
							<p class="text-end price">₩ <%= product.getUnitPrice() %></p>
							<p class="d-flex justify-content-between">
	       						 <a class="nav-link position-relative" aria-current="page" href="./cart_pro.jsp?id=<%= product.getProductId() %>">
	        						<i class="material-symbols-outlined">shopping_bag</i>
	       							 </a>
								<a href="./product.jsp?id=<%= product.getProductId() %>"
								   class="btn btn-primary">상세 정보</a>
